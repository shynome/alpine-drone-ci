...
module.exports = {
  ...
  builder(yargs){
    ...
    function getTags(){
      switch(true){
        ...
        case fs.existsSync('.tags'):
          return fs.readFileSync('.tags','utf-8')
        default:
    ...
    .option('repo',{ require:true, type:'string', default: drone.REPO_NAME, desc: 'repo name' })
    .option('registry',{ type:'string', default: '', desc: 'docker registry' })
  },
  /**@param {Argv} argv */
  handler(argv){
